...
#line 742
typedef int (*__compar_fn_t)(const void *arg_0x2ab62b6661f0, const void *arg_0x2ab62b6664c8);
#line 776
__extension__ 
#line 793
__extension__ 
...
typedef TMilli CombinerC$MilliTimer$precision_tag;
...
static void gatewayTOSC$Boot$booted(void );
# 4 "Combine.nc"
static void gatewayTOSC$Combine$DataReady(packet_msg_t *buffer);
# 60 "/home/ondra/symphony/release/tinyos-2.1.1/tos/interfaces/ActiveMessageAddress.nc"
static void gatewayTOSC$ActiveMessageAddress$changed(void );
# 80 "/home/ondra/symphony/release/tinyos-2.1.1/tos/interfaces/AMSend.nc"
static error_t /*gatewayTOSApp.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
static void /*gatewayTOSApp.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(
#line 96
message_t * msg, 
...
uint8_t arg_0x2ab62bc0a160);
# 113 "/home/ondra/symphony/release/tinyos-2.1.1/tos/interfaces/SplitControl.nc"
static void CombinerC$AMControl$startDone(error_t error);
# 110 "/home/ondra/symphony/release/tinyos-2.1.1/tos/interfaces/AMSend.nc"
static void CombinerC$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 5 "Combine.nc"
static void CombinerC$Combine$StartWork(void );
# 83 "/home/ondra/symphony/release/tinyos-2.1.1/tos/lib/timer/Timer.nc"
static void CombinerC$MilliTimer$fired(void );
# 78 "/home/ondra/symphony/release/tinyos-2.1.1/tos/interfaces/Receive.nc"
static 
#line 74
message_t * 
...
uint8_t len);
# 75 "/home/ondra/symphony/release/tinyos-2.1.1/tos/interfaces/TaskBasic.nc"
static void CombinerC$sendConfirm$runTask(void );
# 62 "/home/ondra/symphony/release/tinyos-2.1.1/tos/interfaces/Init.nc"
...
# 5 "Combine.nc"
static void gatewayTOSC$Combine$StartWork(void );
# 45 "/home/ondra/symphony/release/tinyos-2.1.1/tos/interfaces/ActiveMessageAddress.nc"
static void gatewayTOSC$ActiveMessageAddress$setAddress(am_group_t group, am_addr_t addr);
# 14 "gatewayTOSC.nc"
static inline void gatewayTOSC$Boot$booted(void );
...
static inline void gatewayTOSC$ActiveMessageAddress$changed(void );



static inline void gatewayTOSC$Combine$DataReady(packet_msg_t *buffer);
# 110 "/home/ondra/symphony/release/tinyos-2.1.1/tos/interfaces/AMSend.nc"
static void /*gatewayTOSApp.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/home/ondra/symphony/release/tinyos-2.1.1/tos/interfaces/Send.nc"
static error_t /*gatewayTOSApp.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(
#line 67
message_t * msg, 
...
static void /*gatewayTOSApp.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*gatewayTOSApp.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(
#line 158
message_t * amsg, 
...
static inline error_t /*gatewayTOSApp.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*gatewayTOSApp.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(message_t *m, error_t err);
# 80 "/home/ondra/symphony/release/tinyos-2.1.1/tos/interfaces/AMSend.nc"
...
enum /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$__nesc_unnamed4287 {
#line 126
...
#line 57
#line 55
typedef struct /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$__nesc_unnamed4289 {
  message_t * msg;
...
enum Ns3ActiveMessageC$__nesc_unnamed4290 {
#line 54
  Ns3ActiveMessageC$SplitControlStartDone = 2U
};
#line 54
...
enum NS3MsgGatewayP$__nesc_unnamed4291 {
#line 40
  NS3MsgGatewayP$sendDoneTask = 3U
};
#line 40
...
uint8_t arg_0x2ab62bc0a160);
#line 71
enum /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$__nesc_unnamed4293 {
#line 71
...
#line 59
typedef struct /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$__nesc_unnamed4295 {
...
# 104 "/home/ondra/symphony/release/tinyos-2.1.1/tos/interfaces/SplitControl.nc"
static error_t CombinerC$AMControl$start(void );
# 80 "/home/ondra/symphony/release/tinyos-2.1.1/tos/interfaces/AMSend.nc"
static error_t CombinerC$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 4 "Combine.nc"
static void CombinerC$Combine$DataReady(packet_msg_t *buffer);
...
uint8_t len);
# 68 "/home/ondra/symphony/release/tinyos-2.1.1/tos/interfaces/AMPacket.nc"
static am_addr_t CombinerC$AMPacket$address(void );
# 17 "CombinerC.nc"
enum CombinerC$__nesc_unnamed4296 {
#line 17
  CombinerC$sendConfirm = 6U
};
#line 17
typedef int CombinerC$__nesc_sillytask_sendConfirm[CombinerC$sendConfirm];
uint16_t CombinerC$sender;
bool CombinerC$locked;

message_t CombinerC$packetS;
packet_msg_t *CombinerC$dataBank[100];

static inline void CombinerC$AMControl$startDone(error_t err);
#line 37
static inline void CombinerC$MilliTimer$fired(void );


static inline void CombinerC$sendConfirm$runTask(void );




static inline message_t *CombinerC$Receive$receive(message_t *bufPtr, void *payload, uint8_t len);
#line 98
static inline void CombinerC$AMSend$sendDone(message_t *bufPtr, error_t error);
...
static inline void CombinerC$Combine$StartWork(void );
...
{
  if (error == SUCCESS) {
      CombinerC$locked = FALSE;
      printf("COMBINER event void AMSend.sendDone %d\n", TOS_NODE_ID);
    }
}

# 110 "/home/ondra/symphony/release/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static void /*gatewayTOSApp.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(message_t * msg, error_t error){
#line 110
  CombinerC$AMSend$sendDone(msg, error);
#line 110
}
#line 110
...
#line 65
{
  /*gatewayTOSApp.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(m, err);
}
...
# 100 "/home/ondra/symphony/release/tinyos-2.1.1/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0x2ab62bab0b90, message_t * msg, error_t error){
#line 100
  switch (arg_0x2ab62bab0b90) {
#line 100
    case 0U:
#line 100
      /*gatewayTOSApp.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0x2ab62bab0b90, msg, error);
#line 100
      break;
#line 100
    }
...
# 104 "/home/ondra/symphony/release/tinyos-2.1.1/tos/interfaces/SplitControl.nc"
inline static error_t CombinerC$AMControl$start(void ){
#line 104
  unsigned char __nesc_result;
#line 104
...
# 68 "/home/ondra/symphony/release/tinyos-2.1.1/tos/interfaces/AMPacket.nc"
inline static am_addr_t CombinerC$AMPacket$address(void ){
#line 68
  unsigned short __nesc_result;
#line 68
...
#line 113
  CombinerC$AMControl$startDone(error);
#line 113
}
#line 113
# 54 "/home/ondra/symphony/release/tinyos-2.1.1/tos/platforms/ns3/Ns3ActiveMessageC.nc"
...
# 110 "/home/ondra/symphony/release/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static void Ns3ActiveMessageC$AMSend$sendDone(am_id_t arg_0x2ab62bb02900, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0x2ab62bb02900, msg, error);
#line 110
}
#line 110
...
# 78 "/home/ondra/symphony/release/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * Ns3ActiveMessageC$Snoop$receive(am_id_t arg_0x2ab62bb00670, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = Ns3ActiveMessageC$Snoop$default$receive(arg_0x2ab62bb00670, msg, payload, len);
#line 78
...
static inline void gatewayTOSC$Combine$DataReady(packet_msg_t *buffer)
{
  ...
  printf("\nGWTOS DATA READY SIZE %d Timestamp %d NodeId %d\n", __nesc_ntoh_uint32(buffer->size.nxdata), __nesc_ntoh_uint32(buffer->timestamp.nxdata), __nesc_ntoh_uint16(buffer->nodeID.nxdata));
}

# 4 "Combine.nc"
inline static void CombinerC$Combine$DataReady(packet_msg_t *buffer){
#line 4
  gatewayTOSC$Combine$DataReady(buffer);
#line 4
}
#line 4
# 80 "/home/ondra/symphony/release/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0x2ab62baafd28, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = Ns3ActiveMessageC$AMSend$send(arg_0x2ab62baafd28, addr, msg, len);
#line 80
...
# 75 "/home/ondra/symphony/release/tinyos-2.1.1/tos/interfaces/Send.nc"
inline static error_t /*gatewayTOSApp.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
inline static void /*gatewayTOSApp.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(message_t * amsg, am_id_t t){
#line 162
...
# 103 "/home/ondra/symphony/release/tinyos-2.1.1/tos/interfaces/AMPacket.nc"
inline static void /*gatewayTOSApp.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 103
...
#line 55
{
  /*gatewayTOSApp.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(msg, dest);
  /*gatewayTOSApp.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(msg, 6);
  return /*gatewayTOSApp.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(msg, len);
}

# 80 "/home/ondra/symphony/release/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static error_t CombinerC$AMSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*gatewayTOSApp.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(addr, msg, len);
#line 80
...
# 126 "/home/ondra/symphony/release/tinyos-2.1.1/tos/interfaces/Packet.nc"
inline static void * CombinerC$Packet$getPayload(message_t * msg, uint8_t len){
#line 126
  void *__nesc_result;
#line 126
...
#line 51
  CombinerC$sender = __nesc_ntoh_uint8(msg->sender.nxdata);
  __nesc_hton_uint16(partNr.nxdata, __nesc_ntoh_uint16(msg->partNr.nxdata));
  printf("COMBINER:: RECEIVED SENDER:%d PARTNR: %d\n", CombinerC$sender, __nesc_ntoh_uint16(partNr.nxdata));

  if (__nesc_ntoh_uint16(partNr.nxdata) == 0) {


      memcpy(&size, msg->data, 2);

      CombinerC$dataBank[CombinerC$sender] = (packet_msg_t *)malloc(sizeof(packet_msg_t ) + __nesc_ntoh_uint16(size.nxdata));
      printf("Raw addr %d %d\n", CombinerC$dataBank[CombinerC$sender], CombinerC$dataBank[CombinerC$sender]->rawData);

      __nesc_hton_uint16(CombinerC$dataBank[CombinerC$sender]->nodeID.nxdata, CombinerC$sender);

      printf("Allocated\n");

      memcpy(& CombinerC$dataBank[CombinerC$sender]->timestamp, msg->data + sizeof(nx_uint16_t ), sizeof(nx_uint32_t ));
      __nesc_hton_uint32(CombinerC$dataBank[CombinerC$sender]->size.nxdata, __nesc_ntoh_uint16(size.nxdata));
      printf("SAVED TO DATABANK sender: %d timestamp: %d size: %d\n", __nesc_ntoh_uint16(CombinerC$dataBank[CombinerC$sender]->nodeID.nxdata), __nesc_ntoh_uint32(CombinerC$dataBank[CombinerC$sender]->timestamp.nxdata), __nesc_ntoh_uint32(CombinerC$dataBank[CombinerC$sender]->size.nxdata));

      printf("COMBINER::void send conf to %d\n", CombinerC$sender);
      if (CombinerC$locked == 1) {
          printf("LOCKED::%x\n", TOS_NODE_ID);
          return bufPtr;
        }
      sP = (radio_conf_msg_t *)CombinerC$Packet$getPayload(&CombinerC$packetS, sizeof(radio_conf_msg_t ));
      if (CombinerC$AMSend$send(CombinerC$sender, &CombinerC$packetS, sizeof(radio_conf_msg_t )) == SUCCESS) {
          CombinerC$locked = TRUE;
        }
    }
  else 
    {
      uint16_t left = __nesc_ntoh_uint32(CombinerC$dataBank[CombinerC$sender]->size.nxdata) - 25 * (__nesc_ntoh_uint16(partNr.nxdata) - 1);

#line 84
      printf("WRITE OFFSET:%d LEFT:%d\n", (__nesc_ntoh_uint16(partNr.nxdata) - 1) * 25, left);
      printf("Will copy to %d\n", CombinerC$dataBank[CombinerC$sender]->rawData + (__nesc_ntoh_uint16(partNr.nxdata) - 1) * 25);
      memcpy(CombinerC$dataBank[CombinerC$sender]->rawData + (__nesc_ntoh_uint16(partNr.nxdata) - 1) * 25, msg->data, left > 25 ? 25 : left);
      printf("Going to check LEFT %d  cond %d\n", left, left < 26);
      if (left < 26) {
          printf("COMBINER SIGNALING DATAREADY\n");
          CombinerC$Combine$DataReady(CombinerC$dataBank[CombinerC$sender]);
        }
    }
...
# 78 "/home/ondra/symphony/release/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * Ns3ActiveMessageC$Receive$receive(am_id_t arg_0x2ab62bb01a90, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x2ab62bb01a90) {
#line 78
    case 6:
#line 78
      __nesc_result = CombinerC$Receive$receive(msg, payload, len);
#line 78
      break;
#line 78
    default:
#line 78
      __nesc_result = Ns3ActiveMessageC$Receive$default$receive(arg_0x2ab62bb01a90, msg, payload, len);
#line 78
      break;
#line 78
    }
...
#line 78
# 198 "/home/ondra/symphony/release/tinyos-2.1.1/tos/platforms/ns3/Ns3ActiveMessageC.nc"
static __inline bool Ns3ActiveMessageC$AMPacket$isForMe(message_t *msg)
{
...
# 75 "/home/ondra/symphony/release/tinyos-2.1.1/tos/interfaces/TaskBasic.nc"
inline static void SchedulerBasicP$TaskBasic$runTask(uint8_t arg_0x2ab62b92e960){
#line 75
  switch (arg_0x2ab62b92e960) {
#line 75
...
#line 75
      break;
#line 75
    case CombinerC$sendConfirm:
#line 75
      CombinerC$sendConfirm$runTask();
#line 75
      break;
#line 75
    default:
#line 75
      SchedulerBasicP$TaskBasic$default$runTask(arg_0x2ab62b92e960);
#line 75
      break;
#line 75
    }
...
# 83 "/home/ondra/symphony/release/tinyos-2.1.1/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x2ab62bc0a160){
#line 83
  switch (arg_0x2ab62bc0a160) {
#line 83
    case 0U:
#line 83
      CombinerC$MilliTimer$fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x2ab62bc0a160);
#line 83
      break;
#line 83
    }
...
# 59 "/home/ondra/symphony/release/tinyos-2.1.1/tos/interfaces/SendNotifier.nc"
inline static void Ns3ActiveMessageC$SendNotifier$aboutToSend(am_id_t arg_0x2ab62baff1a0, am_addr_t dest, message_t * msg){
#line 59
    Ns3ActiveMessageC$SendNotifier$default$aboutToSend(arg_0x2ab62baff1a0, dest, msg);
#line 59
}
#line 59
...
# 5 "Combine.nc"
inline static void gatewayTOSC$Combine$StartWork(void ){
#line 5
  CombinerC$Combine$StartWork();
#line 5
}
#line 5
# 21 "gatewayTOSC.nc"
...
#line 60
  gatewayTOSC$ActiveMessageAddress$changed();
#line 60
}
#line 60
...
# 45 "/home/ondra/symphony/release/tinyos-2.1.1/tos/interfaces/ActiveMessageAddress.nc"
inline static void gatewayTOSC$ActiveMessageAddress$setAddress(am_group_t group, am_addr_t addr){
#line 45
...
#line 14
{
  ...
  gatewayTOSC$ActiveMessageAddress$setAddress(AM_GROUPNR, TOS_NODE_ID);

  gatewayTOSC$Combine$StartWork();
}

# 60 "/home/ondra/symphony/release/tinyos-2.1.1/tos/interfaces/Boot.nc"
inline static void SimMainP$Boot$booted(void ){
#line 60
  gatewayTOSC$Boot$booted();
#line 60
}
#line 60
