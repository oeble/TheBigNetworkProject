...
public class CopyOfAutoScaling_BF {
	...
	private static final String AUTO_SCALING_GROUP_NAME = "12_LP1_ASG_D7001D_group5_prep";
	private static final String LAUNCH_CONFIGURATION_NAME = "12_LP1_ASLC_D7001D_group5_prep";
	...
	public CopyOfAutoScaling_BF() {
		...
		if (CREATE_LOAD_BALANCER) {
			...
			new LoadBalancing(ELB_NAME, credentials, ELB_AVAILIABILITY_ZONE,
					ELB_PORT);
		}
		...
		if (CREATE_ALARMS) {
			...
			try {
				ARN = LoadPolicyUpARN();
				CloudWatch CW = new CloudWatch(AUTO_SCALING_GROUP_NAME, credentials);
				//SCALE UP ALARM
